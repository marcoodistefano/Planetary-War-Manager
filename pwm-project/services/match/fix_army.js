...
const db = new Pool({ host: 'localhost', user: 'commander_admin', password: 'commander_password', database: 'pwm_tactical_database', port: 5432 });

async function fix() {
    await db.query(`DELETE FROM mosse WHERE id_armata = 'af772bf9-4821-4fb8-8012-9611020faabd'`);
