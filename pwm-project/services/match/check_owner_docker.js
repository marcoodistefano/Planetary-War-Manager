        ...
        for (const key of keys) {
            ...
            if (nationsStr) {
                ...
                for (const nation of nations) {
                    if (nation.territories_flat && (nation.territories_flat.includes('Nakhon Ratchasima') || nation.territories_flat.includes('THA-30') || nation.territories_flat.includes('THA-3046'))) {
